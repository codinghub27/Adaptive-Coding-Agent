...
model SDKs. This is checked in a subprocess (of our own fixed command, no
user input) so the heavy modules a *previous* test may have already imported
into this process can't mask a regression.
"""
